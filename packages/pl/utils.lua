...
local compat = require 'packages.pl.compat'
...
function utils.function_arg (idx,f,msg)
    ...
    if tp == 'string' then
        if not operators then operators = require 'packages.pl.operator'.optable end
...
--     "-lluacov",
--     "-e",
--     "utils = print(require('packages.pl.utils')._VERSION",
-- }
-- -- returns: -lluacov -e 'utils = print(require('\''packages.pl.utils'\'')._VERSION'
